// Generated by gencpp from file ubt_core_msgs/EndEffectorProperties.msg
// DO NOT EDIT!


#ifndef UBT_CORE_MSGS_MESSAGE_ENDEFFECTORPROPERTIES_H
#define UBT_CORE_MSGS_MESSAGE_ENDEFFECTORPROPERTIES_H
...
struct EndEffectorProperties_
{
  ...
  typedef boost::shared_ptr< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> const> ConstPtr;

}; // struct EndEffectorProperties_

typedef ::ubt_core_msgs::EndEffectorProperties_<std::allocator<void> > EndEffectorProperties;

typedef boost::shared_ptr< ::ubt_core_msgs::EndEffectorProperties > EndEffectorPropertiesPtr;
typedef boost::shared_ptr< ::ubt_core_msgs::EndEffectorProperties const> EndEffectorPropertiesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x21b83773ab9a3521ULL;
  static const uint64_t static_value2 = 0x6d11e427573c76ccULL;
};

template<class ContainerAllocator>
struct DataType< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ubt_core_msgs::EndEffectorProperties_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
...
#endif // UBT_CORE_MSGS_MESSAGE_ENDEFFECTORPROPERTIES_H
