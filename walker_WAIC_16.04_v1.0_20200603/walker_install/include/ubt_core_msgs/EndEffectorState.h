// Generated by gencpp from file ubt_core_msgs/EndEffectorState.msg
// DO NOT EDIT!


#ifndef UBT_CORE_MSGS_MESSAGE_ENDEFFECTORSTATE_H
#define UBT_CORE_MSGS_MESSAGE_ENDEFFECTORSTATE_H
...
struct EndEffectorState_
{
  ...
  typedef boost::shared_ptr< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> const> ConstPtr;

}; // struct EndEffectorState_

typedef ::ubt_core_msgs::EndEffectorState_<std::allocator<void> > EndEffectorState;

typedef boost::shared_ptr< ::ubt_core_msgs::EndEffectorState > EndEffectorStatePtr;
typedef boost::shared_ptr< ::ubt_core_msgs::EndEffectorState const> EndEffectorStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ubt_core_msgs::EndEffectorState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xade777f069d73859ULL;
  static const uint64_t static_value2 = 0x5bc19e246b8ec7a0ULL;
};

template<class ContainerAllocator>
struct DataType< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ubt_core_msgs::EndEffectorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ubt_core_msgs::EndEffectorState_<ContainerAllocator>& v)
  {
    s << indent << "timestamp: ";
...
#endif // UBT_CORE_MSGS_MESSAGE_ENDEFFECTORSTATE_H
