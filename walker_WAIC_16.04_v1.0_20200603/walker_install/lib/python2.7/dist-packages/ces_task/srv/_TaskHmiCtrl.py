...
"""autogenerated by genpy from ces_task/TaskHmiCtrlRequest.msg. Do not edit."""
import sys
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.adb_cmd = str[start:end].decode('utf-8')
      else:
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ces_task/TaskHmiCtrlResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
def _get_struct_B():
    ...
    return _struct_B
class TaskHmiCtrl(object):
  _type          = 'ces_task/TaskHmiCtrl'
  _md5sum = 'd451323ce918ea804b0b0df774879b87'
  _request_class  = TaskHmiCtrlRequest
  _response_class = TaskHmiCtrlResponse
