...
"""autogenerated by genpy from serial_device/TaskServiceRequest.msg. Do not edit."""
import sys
...
class TaskServiceRequest(genpy.Message):
  ...
  _type = "serial_device/TaskServiceRequest"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.useJointOTG = map(bool, self.useJointOTG)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.useCartOTG = map(bool, self.useCartOTG)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.securityDection = map(bool, self.securityDection)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.collisionDetection = map(bool, self.collisionDetection)
      return self
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from serial_device/TaskServiceResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class TaskServiceResponse(genpy.Message):
  ...
  _type = "serial_device/TaskServiceResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
bool result
string message
...
class TaskService(object):
  _type          = 'serial_device/TaskService'
