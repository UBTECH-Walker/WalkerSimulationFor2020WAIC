...
(cl:defclass <cruiserCanCount> (roslisp-msg-protocol:ros-message)
  ((data1
    :reader data1
    :initarg :data1
    :type cl:integer
...
(cl:defclass cruiserCanCount (<cruiserCanCount>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <cruiserCanCount>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'cruiserCanCount)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cruiser_msgs-msg:<cruiserCanCount> is deprecated: use cruiser_msgs-msg:cruiserCanCount instead.")))

(cl:ensure-generic-function 'data1-val :lambda-list '(m))
(cl:defmethod data1-val ((m <cruiserCanCount>))
...
(cl:defmethod data2-val ((m <cruiserCanCount>))
...
(cl:defmethod data3-val ((m <cruiserCanCount>))
...
(cl:defmethod data4-val ((m <cruiserCanCount>))
...
(cl:defmethod data5-val ((m <cruiserCanCount>))
...
(cl:defmethod data6-val ((m <cruiserCanCount>))
  ...
  (data6 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cruiserCanCount>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cruiserCanCount>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cruiserCanCount>)))
  "Returns string type for a message object of type '<cruiserCanCount>"
  "cruiser_msgs/cruiserCanCount")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cruiserCanCount)))
  "Returns string type for a message object of type 'cruiserCanCount"
  "cruiser_msgs/cruiserCanCount")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cruiserCanCount>)))
  "Returns md5sum for a message object of type '<cruiserCanCount>"
  "ca7cc81c4478bf5d727f35a1887362ee")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cruiserCanCount)))
  "Returns md5sum for a message object of type 'cruiserCanCount"
  "ca7cc81c4478bf5d727f35a1887362ee")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cruiserCanCount>)))
  "Returns full string definition for message of type '<cruiserCanCount>"
  (cl:format cl:nil "uint32 data1~%uint32 data2~%uint32 data3~%uint32 data4~%uint32 data5~%uint32 data6~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cruiserCanCount)))
  "Returns full string definition for message of type 'cruiserCanCount"
  (cl:format cl:nil "uint32 data1~%uint32 data2~%uint32 data3~%uint32 data4~%uint32 data5~%uint32 data6~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cruiserCanCount>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cruiserCanCount>))
  "Converts a ROS message object to a list"
  (cl:list 'cruiserCanCount
