...
(cl:defmethod cl:initialize-instance :after ((m <AnalogIOState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnalogIOState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<AnalogIOState> is deprecated: use ubt_core_msgs-msg:AnalogIOState instead.")))
...
(cl:defmethod value-val ((m <AnalogIOState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:value-val is deprecated.  Use ubt_core_msgs-msg:value instead.")
  (value m))

(cl:ensure-generic-function 'isInputOnly-val :lambda-list '(m))
(cl:defmethod isInputOnly-val ((m <AnalogIOState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:isInputOnly-val is deprecated.  Use ubt_core_msgs-msg:isInputOnly instead.")
  (isInputOnly m))
