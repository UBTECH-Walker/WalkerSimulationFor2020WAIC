...
(cl:defclass <AssemblyStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector ubt_core_msgs-msg:AssemblyState)
   :initform (cl:make-array 0 :element-type 'ubt_core_msgs-msg:AssemblyState :initial-element (cl:make-instance 'ubt_core_msgs-msg:AssemblyState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AssemblyStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AssemblyStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<AssemblyStates> is deprecated: use ubt_core_msgs-msg:AssemblyStates instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AssemblyStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'ubt_core_msgs-msg:AssemblyState))
