...
(cl:defmethod cl:initialize-instance :after ((m <DigitalIOState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitalIOState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<DigitalIOState> is deprecated: use ubt_core_msgs-msg:DigitalIOState instead.")))
