...
(cl:defmethod cl:initialize-instance :after ((m <HeadState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeadState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<HeadState> is deprecated: use ubt_core_msgs-msg:HeadState instead.")))

(cl:ensure-generic-function 'pan-val :lambda-list '(m))
(cl:defmethod pan-val ((m <HeadState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:pan-val is deprecated.  Use ubt_core_msgs-msg:pan instead.")
  (pan m))

(cl:ensure-generic-function 'isTurning-val :lambda-list '(m))
(cl:defmethod isTurning-val ((m <HeadState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:isTurning-val is deprecated.  Use ubt_core_msgs-msg:isTurning instead.")
  (isTurning m))

(cl:ensure-generic-function 'isNodding-val :lambda-list '(m))
(cl:defmethod isNodding-val ((m <HeadState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:isNodding-val is deprecated.  Use ubt_core_msgs-msg:isNodding instead.")
  (isNodding m))

(cl:ensure-generic-function 'isPanEnabled-val :lambda-list '(m))
(cl:defmethod isPanEnabled-val ((m <HeadState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:isPanEnabled-val is deprecated.  Use ubt_core_msgs-msg:isPanEnabled instead.")
  (isPanEnabled m))
