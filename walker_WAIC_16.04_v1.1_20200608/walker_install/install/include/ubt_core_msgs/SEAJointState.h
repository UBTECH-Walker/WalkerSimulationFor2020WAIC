// Generated by gencpp from file ubt_core_msgs/SEAJointState.msg
// DO NOT EDIT!


#ifndef UBT_CORE_MSGS_MESSAGE_SEAJOINTSTATE_H
#define UBT_CORE_MSGS_MESSAGE_SEAJOINTSTATE_H
...
struct SEAJointState_
{
  ...
  typedef boost::shared_ptr< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> const> ConstPtr;

}; // struct SEAJointState_

typedef ::ubt_core_msgs::SEAJointState_<std::allocator<void> > SEAJointState;

typedef boost::shared_ptr< ::ubt_core_msgs::SEAJointState > SEAJointStatePtr;
typedef boost::shared_ptr< ::ubt_core_msgs::SEAJointState const> SEAJointStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ubt_core_msgs::SEAJointState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ubt_core_msgs::SEAJointState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd36406dcbb6d860bULL;
  static const uint64_t static_value2 = 0x1b39c4e28f81352bULL;
};

template<class ContainerAllocator>
struct DataType< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ubt_core_msgs::SEAJointState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ubt_core_msgs::SEAJointState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // UBT_CORE_MSGS_MESSAGE_SEAJOINTSTATE_H
