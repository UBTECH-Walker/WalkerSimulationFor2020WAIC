...
class EcatLimitSrvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EcatLimitSrvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EcatLimitSrvRequest
    let len;
    let data = new EcatLimitSrvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EcatLimitSrvRequest(null);
...
class EcatLimitSrvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EcatLimitSrvResponse
    // Serialize message field [enable]
    bufferOffset = _serializer.bool(obj.enable, buffer, bufferOffset);
    // Serialize message field [min]
    bufferOffset = _serializer.float32(obj.min, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EcatLimitSrvResponse
    let len;
    let data = new EcatLimitSrvResponse(null);
    // Deserialize message field [enable]
    data.enable = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [min]
    data.min = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EcatLimitSrvResponse(null);
    if (msg.enable !== undefined) {
      resolved.enable = msg.enable;
    }
    else {
...
module.exports = {
  Request: EcatLimitSrvRequest,
  Response: EcatLimitSrvResponse,
  md5sum() { return 'e3d452c6cafa43f5461e27d1edc8c915'; },
  datatype() { return 'servo_ctrl/EcatLimitSrv'; }
};
