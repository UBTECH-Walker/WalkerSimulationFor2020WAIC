...
(cl:defmethod cl:initialize-instance :after ((m <DigitalOutputCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitalOutputCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<DigitalOutputCommand> is deprecated: use ubt_core_msgs-msg:DigitalOutputCommand instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <DigitalOutputCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:name-val is deprecated.  Use ubt_core_msgs-msg:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DigitalOutputCommand>)))
  ...
  "ubt_core_msgs/DigitalOutputCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DigitalOutputCommand)))
  "Returns string type for a message object of type 'DigitalOutputCommand"
  "ubt_core_msgs/DigitalOutputCommand")
