...
(cl:defclass <EndpointStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector ubt_core_msgs-msg:EndpointState)
   :initform (cl:make-array 0 :element-type 'ubt_core_msgs-msg:EndpointState :initial-element (cl:make-instance 'ubt_core_msgs-msg:EndpointState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EndpointStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EndpointStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<EndpointStates> is deprecated: use ubt_core_msgs-msg:EndpointStates instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EndpointStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'ubt_core_msgs-msg:EndpointState))
