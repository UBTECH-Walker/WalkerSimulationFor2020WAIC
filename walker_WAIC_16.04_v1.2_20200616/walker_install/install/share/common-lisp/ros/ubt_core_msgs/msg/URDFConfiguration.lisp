...
(cl:defmethod cl:initialize-instance :after ((m <URDFConfiguration>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'URDFConfiguration)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<URDFConfiguration> is deprecated: use ubt_core_msgs-msg:URDFConfiguration instead.")))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <URDFConfiguration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:time-val is deprecated.  Use ubt_core_msgs-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'link-val :lambda-list '(m))
(cl:defmethod link-val ((m <URDFConfiguration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:link-val is deprecated.  Use ubt_core_msgs-msg:link instead.")
  (link m))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <URDFConfiguration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:joint-val is deprecated.  Use ubt_core_msgs-msg:joint instead.")
  (joint m))

(cl:ensure-generic-function 'urdf-val :lambda-list '(m))
(cl:defmethod urdf-val ((m <URDFConfiguration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:urdf-val is deprecated.  Use ubt_core_msgs-msg:urdf instead.")
  (urdf m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<URDFConfiguration>)))
  ...
  "ubt_core_msgs/URDFConfiguration")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'URDFConfiguration)))
  "Returns string type for a message object of type 'URDFConfiguration"
  "ubt_core_msgs/URDFConfiguration")
