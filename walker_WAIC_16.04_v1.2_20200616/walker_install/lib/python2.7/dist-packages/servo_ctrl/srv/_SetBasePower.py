...
"""autogenerated by genpy from servo_ctrl/SetBasePowerRequest.msg. Do not edit."""
import sys
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from servo_ctrl/SetBasePowerResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class SetBasePower(object):
  _type          = 'servo_ctrl/SetBasePower'
  _md5sum = 'b0bc70d7e1fded55183cc6d4deee36a2'
  _request_class  = SetBasePowerRequest
  _response_class = SetBasePowerResponse
