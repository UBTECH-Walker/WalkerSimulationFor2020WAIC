...
(cl:defmethod cl:initialize-instance :after ((m <CameraControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CameraControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<CameraControl> is deprecated: use ubt_core_msgs-msg:CameraControl instead.")))
