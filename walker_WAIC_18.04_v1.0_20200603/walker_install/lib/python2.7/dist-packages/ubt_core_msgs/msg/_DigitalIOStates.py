...
"""autogenerated by genpy from ubt_core_msgs/DigitalIOStates.msg. Do not edit."""
import sys
...
class DigitalIOStates(genpy.Message):
  ...
  _type = "ubt_core_msgs/DigitalIOStates"
...
int8 UNPRESSED = 0"""
  ...
  _slot_types = ['string[]','ubt_core_msgs/DigitalIOState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = ubt_core_msgs.msg.DigitalIOState()
        _x = val1
        start = end
        end += 2
