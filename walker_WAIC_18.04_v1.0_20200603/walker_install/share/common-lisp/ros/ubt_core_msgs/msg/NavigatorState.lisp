...
(cl:defmethod cl:initialize-instance :after ((m <NavigatorState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigatorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<NavigatorState> is deprecated: use ubt_core_msgs-msg:NavigatorState instead.")))

(cl:ensure-generic-function 'button_names-val :lambda-list '(m))
(cl:defmethod button_names-val ((m <NavigatorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:button_names-val is deprecated.  Use ubt_core_msgs-msg:button_names instead.")
  (button_names m))

(cl:ensure-generic-function 'buttons-val :lambda-list '(m))
(cl:defmethod buttons-val ((m <NavigatorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:buttons-val is deprecated.  Use ubt_core_msgs-msg:buttons instead.")
  (buttons m))

(cl:ensure-generic-function 'wheel-val :lambda-list '(m))
(cl:defmethod wheel-val ((m <NavigatorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:wheel-val is deprecated.  Use ubt_core_msgs-msg:wheel instead.")
  (wheel m))

(cl:ensure-generic-function 'light_names-val :lambda-list '(m))
(cl:defmethod light_names-val ((m <NavigatorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:light_names-val is deprecated.  Use ubt_core_msgs-msg:light_names instead.")
  (light_names m))

(cl:ensure-generic-function 'lights-val :lambda-list '(m))
(cl:defmethod lights-val ((m <NavigatorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:lights-val is deprecated.  Use ubt_core_msgs-msg:lights instead.")
  (lights m))
