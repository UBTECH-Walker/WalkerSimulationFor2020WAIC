...
(cl:defclass <NavigatorStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector ubt_core_msgs-msg:NavigatorState)
   :initform (cl:make-array 0 :element-type 'ubt_core_msgs-msg:NavigatorState :initial-element (cl:make-instance 'ubt_core_msgs-msg:NavigatorState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <NavigatorStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigatorStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ubt_core_msgs-msg:<NavigatorStates> is deprecated: use ubt_core_msgs-msg:NavigatorStates instead.")))

(cl:ensure-generic-function 'names-val :lambda-list '(m))
(cl:defmethod names-val ((m <NavigatorStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:names-val is deprecated.  Use ubt_core_msgs-msg:names instead.")
  (names m))

(cl:ensure-generic-function 'states-val :lambda-list '(m))
(cl:defmethod states-val ((m <NavigatorStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ubt_core_msgs-msg:states-val is deprecated.  Use ubt_core_msgs-msg:states instead.")
  (states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <NavigatorStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'ubt_core_msgs-msg:NavigatorState))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<NavigatorStates>)))
  ...
  (cl:format cl:nil "# used when publishing multiple navigators~%string[]         names~%NavigatorState[] states~%~%================================================================================~%MSG: ubt_core_msgs/NavigatorState~%# buttons~%string[] button_names~%bool[] buttons~%~%# wheel position~%uint8   wheel~%~%# true if the light is on, false if not~%# lights map to button names~%string[] light_names~%bool[] lights~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'NavigatorStates)))
  "Returns full string definition for message of type 'NavigatorStates"
  (cl:format cl:nil "# used when publishing multiple navigators~%string[]         names~%NavigatorState[] states~%~%================================================================================~%MSG: ubt_core_msgs/NavigatorState~%# buttons~%string[] button_names~%bool[] buttons~%~%# wheel position~%uint8   wheel~%~%# true if the light is on, false if not~%# lights map to button names~%string[] light_names~%bool[] lights~%~%~%"))
