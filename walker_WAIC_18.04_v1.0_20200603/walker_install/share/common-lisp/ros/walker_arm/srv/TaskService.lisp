...
(cl:defmethod cl:initialize-instance :after ((m <TaskService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TaskService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name walker_arm-srv:<TaskService-request> is deprecated: use walker_arm-srv:TaskService-request instead.")))

(cl:ensure-generic-function 'taskName-val :lambda-list '(m))
(cl:defmethod taskName-val ((m <TaskService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_arm-srv:taskName-val is deprecated.  Use walker_arm-srv:taskName instead.")
  (taskName m))

(cl:ensure-generic-function 'taskEnable-val :lambda-list '(m))
(cl:defmethod taskEnable-val ((m <TaskService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_arm-srv:taskEnable-val is deprecated.  Use walker_arm-srv:taskEnable instead.")
  (taskEnable m))

(cl:ensure-generic-function 'useJointOTG-val :lambda-list '(m))
(cl:defmethod useJointOTG-val ((m <TaskService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_arm-srv:useJointOTG-val is deprecated.  Use walker_arm-srv:useJointOTG instead.")
  (useJointOTG m))

(cl:ensure-generic-function 'useCartOTG-val :lambda-list '(m))
(cl:defmethod useCartOTG-val ((m <TaskService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_arm-srv:useCartOTG-val is deprecated.  Use walker_arm-srv:useCartOTG instead.")
  (useCartOTG m))

(cl:ensure-generic-function 'securityDection-val :lambda-list '(m))
(cl:defmethod securityDection-val ((m <TaskService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_arm-srv:securityDection-val is deprecated.  Use walker_arm-srv:securityDection instead.")
  (securityDection m))

(cl:ensure-generic-function 'collisionDetection-val :lambda-list '(m))
(cl:defmethod collisionDetection-val ((m <TaskService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_arm-srv:collisionDetection-val is deprecated.  Use walker_arm-srv:collisionDetection instead.")
...
(cl:defmethod cl:initialize-instance :after ((m <TaskService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TaskService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name walker_arm-srv:<TaskService-response> is deprecated: use walker_arm-srv:TaskService-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <TaskService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_arm-srv:result-val is deprecated.  Use walker_arm-srv:result instead.")
  (result m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <TaskService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walker_arm-srv:message-val is deprecated.  Use walker_arm-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TaskService-response>)))
  ...
  "walker_arm/TaskServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TaskService-response)))
  "Returns string type for a service object of type 'TaskService-response"
  "walker_arm/TaskServiceResponse")
