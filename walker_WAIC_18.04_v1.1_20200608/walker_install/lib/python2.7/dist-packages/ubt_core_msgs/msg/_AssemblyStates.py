...
"""autogenerated by genpy from ubt_core_msgs/AssemblyStates.msg. Do not edit."""
import sys
...
class AssemblyStates(genpy.Message):
  ...
  _type = "ubt_core_msgs/AssemblyStates"
...
"""
  ...
  _slot_types = ['string[]','ubt_core_msgs/AssemblyState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = ubt_core_msgs.msg.AssemblyState()
        _x = val1
        start = end
        end += 6
