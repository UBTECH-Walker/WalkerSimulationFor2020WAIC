...
"""autogenerated by genpy from ubt_core_msgs/NavigatorStates.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['string[]','ubt_core_msgs/NavigatorState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = ubt_core_msgs.msg.NavigatorState()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.button_names = []
