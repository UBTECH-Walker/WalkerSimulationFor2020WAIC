...
"""autogenerated by genpy from servo_ctrl/SetFtPeriodRequest.msg. Do not edit."""
import sys
...
def _get_struct_i():
    ...
    return _struct_i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from servo_ctrl/SetFtPeriodResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class SetFtPeriod(object):
  _type          = 'servo_ctrl/SetFtPeriod'
  _md5sum = 'da5f21de43d7b8e0a73c301ba13f71ef'
  _request_class  = SetFtPeriodRequest
  _response_class = SetFtPeriodResponse
