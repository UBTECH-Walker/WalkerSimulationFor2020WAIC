...
"""autogenerated by genpy from ubt_core_msgs/EndpointStates.msg. Do not edit."""
import sys
...
class EndpointStates(genpy.Message):
  ...
  _type = "ubt_core_msgs/EndpointStates"
...
"""
  ...
  _slot_types = ['string[]','ubt_core_msgs/EndpointState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = ubt_core_msgs.msg.EndpointState()
        _v12 = val1.header
        start = end
        end += 4
