...
class SolvePositionIKRequest {
  ...
  static datatype() {
    ...
    return 'ubt_core_msgs/SolvePositionIKRequest';
  }
...
class SolvePositionIKResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ubt_core_msgs/SolvePositionIKResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'ubt_core_msgs/SolvePositionIK'; }
};
